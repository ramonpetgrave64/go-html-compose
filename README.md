...
<body>
    ...
    <main class="container">
        ...
        <section id="contact">
            ...
            <form>
                <div class="grid"><input type="text" name="firstname" placeholder="First name" aria-label="First name"
                        required="required"></input><input type="email" name="email" placeholder="Email address"
                        aria-label="Email address" autocomplete="email" required="required"></input><button
                        type="submit">Subscribe</button></div>
                <fieldset><label for="terms"><input type="checkbox" role="switch" id="terms" name="terms"></input>I
                        agree to the <a href="#" onclick="alert('Hello, World!')">Privacy Policy</a></label></fieldset>
            </form>
        </section>
    </main>
