...
func generateAttributes() error {
	...
	specNode, err := html.Parse(specFile)
	if err != nil {
		return err
	}
	...
	if _, err = fmt.Fprintf(&content, `// Code generated by "go run -C ../generate ./cmd/generate/"; DO NOT EDIT.
...
%s`, ariaPropSpecialCase, dataPropSpecialCase, RoleSpecialCase, regularAttributeContent, eventHandlerAttributeContent); err != nil {
		return err
	}
...
func makeDoc(attr *attribute) string {
	docSets := []string{}
